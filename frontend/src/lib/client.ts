...
export function Environment(name: string): BaseURL {
  return `https://${name}-future-appointments-p74i.encr.app`;
}
...
/**
 * Client is an API client for the future-appointments-p74i Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "future-appointments-p74i-Generated-TS-Client (Encore/v1.28.0)",
    };
